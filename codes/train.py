...
def main():
    ...
    parser.add_argument('-opt', default='../codes/options/train/train_net.yml',type=str, help='Path to option YMAL file.')
        ...
        for _, train_data in enumerate(train_loader):
            ...
            if current_step % opt['train']['val_freq'] == 0 and rank <= 0:
                ...
                for val_data in val_loader:
                    ...
                    #val_data = cv2.resize(val_data,(512,512))
                    ...
                    cv2.imwrite('../images/{}_out.png'.format(idx),sr)
